    ...
    <div class="content">
      <div class="content_bg">
        ...
        <div class="hbg"><img src="images/header_images.jpg" width="915" height="286" alt="" /></div>
      				<center>
<form name="f1" method="post" action="AuthorLogin" onsubmit="return validate(this);"><br/>
   <h2><b>Reviewer Login Screen</b></h2>
			<br/>
			<%
	...
	out.println("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
		...
		out.println("<center><font size=3 color=red>"+res+"</font></center>");
			...
			<table align="center">
<tr><td><font size="3" color="black"></td><td><input type="hidden" name="t0" value="Reviewers" size="20"/></td></tr>
